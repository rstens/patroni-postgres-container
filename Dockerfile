...
RUN export DEBIAN_FRONTEND=noninteractive \
    ...
    && apt-get update -y \
    && apt-get install -y curl jq locales git build-essential python3 python3-dev python3-pip python3-wheel python3-setuptools python3-virtualenv pgbadger pg-activity postgis postgresql-13-pgrouting \
